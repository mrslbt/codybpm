...
A browser-based progressive metronome. It automatically increases the tempo at timed intervals so you can stay focused on your instrument instead of reaching for the dial.

## What is CodyBPM?

Set your starting BPM, pick how much to increase and how often, hit play, and let it push your speed limits while you practice. Every musician has hit the wall where a passage feels impossible at full speed. The standard advice is always the same: start slow, gradually speed up. But constantly reaching for a metronome dial breaks your flow. CodyBPM automates that.
...
Styled to look like a piece of physical audio hardware. Dark metallic shell, engraved labels, CRT-style scanlines, and a power-on boot animation. The top features an ECG heart-monitor waveform that pulses in sync with the beat, complete with phosphor trails and a sweep cursor.
